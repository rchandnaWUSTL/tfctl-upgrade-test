...
import {
  ...
  id = "dadgarcorp-ws35/app-config"
}

import {
  to = kubernetes_service_account_v1.sa
  id = "dadgarcorp-ws35/deployer"
}

import {
  to = kubernetes_cluster_role_v1.reader
  id = "dadgarcorp-ws35-reader"
}
