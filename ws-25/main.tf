...
import {
  ...
  id = "dadgarcorp-ws25/app-config"
}

import {
  to = kubernetes_service_account_v1.sa
  id = "dadgarcorp-ws25/deployer"
}

import {
  to = kubernetes_cluster_role_v1.reader
  id = "dadgarcorp-ws25-reader"
}
