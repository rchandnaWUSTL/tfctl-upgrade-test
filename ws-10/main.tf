...
import {
  ...
  id = "dadgarcorp-ws10/app-config"
}

import {
  to = kubernetes_service_account_v1.sa
  id = "dadgarcorp-ws10/deployer"
}

import {
  to = kubernetes_secret_v1.creds
  id = "dadgarcorp-ws10/db-creds"
}

import {
  to = kubernetes_cluster_role_v1.reader
  id = "dadgarcorp-ws10-reader"
}
